    ...
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        <form
          ...
          onSubmit={props.handleSubmit(props.onFinishHandler)}
        >
          <FormControl>
            <FormHelperText
              sx={{
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            ...
            >
              {props.propertyImage?.name}
            </Typography>
          </Stack>

          <CustomButton
            type="submit"
            title={props.formLoading ? "Submitting..." : "Submit"}
